...
//         /* ================= NEW HTML ELEMENT LESSON ================= */
//         {
//           id: "html-elements",
//           title: "HTML Elements",

//           description:
//             "An HTML element is everything from the start tag to the end tag. Elements can be nested, some are empty like <br>, and HTML is not case sensitive.",

//           instructions:
//             "1. Add one <h1> heading.\n2. Add one <p> paragraph.\n3. Inside the paragraph use a <br> tag to create a line break.",
...
// <!-- Use a <br> line break inside paragraph -->
      ...
      topics: [
        ...
        // ====================================================
        {
          ...
          content: {
            heading: "Welcome to HTML",
            description:
              "HTML is the foundation of web development. It structures web content using elements and tags.",
            ...
            tasks: [
              ...
              "Learn what tags and elements are."
            ],
        ...
        // ====================================================
        {
          ...
          content: {
            ...
            description:
              "Headings define structure of a webpage using h1 to h6 tags.",

            quote:
              "Structure your code clearly — one heading at a time.",

            tasks: [
              "Create a main title using the <h1> tag.",
              "Add a sub-section using the <h2> tag."
            ],
...
<h2>Sub Title</h2>`
          ...
          questions: [
            {
              ...
              explanation:
                "You must use a proper <h1> tag."
            },

            {
              id: "q2_sub_headings",
              title: "Add H2 Sub Heading",
              ...
              explanation:
                "You must include both <h1> and <h2> tags."
            }
          ]
        },
        ...
        // ====================================================
        {
          ...
          content: {
            ...
            description:
              "Paragraph tags help organize readable text blocks.",
